...
public class activityMyLocation extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
        OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener, LocationListener {

    private static final String TAG = activityMyLocation.class.getSimpleName();
    ...
    protected TextView mLatVal;
    protected TextView mLonVal;
    protected TextView mLocVal;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mLatVal = (TextView) findViewById(R.id.mLatValue);
        mLonVal = (TextView) findViewById(R.id.mLonValue);
        mLocVal = (TextView) findViewById(R.id.mLocValue);
    ...
    public void updateUI() {
        if (mLastLocation == null) {
            ...
            mLatVal.setText(String.valueOf(mLastLocation.getLatitude()));
            mLonVal.setText(String.valueOf(mLastLocation.getLongitude()));
    ...
    class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            mLocVal.setText(mAddressOutput);
